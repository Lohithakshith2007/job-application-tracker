  ...
  return (
    <header className="app-nav">
      <div className="nav-inner">
        ...
        {/* Brand — Text only, no "J" box */}
        <div className="nav-brand" onClick={onOpenLanding}>
          <span className="nav-brand-text">
            Career<span className="nav-brand-dot">.</span>Tracker
          </span>
        </div>
        ...
        <div className="nav-user-area">
          <button className="nav-profile" onClick={() => go('settings')} title="Profile">
            AR
          </button>
          <button
      ...
      {mobileOpen && (
        <div className="nav-drawer">
          ...
          <button className="nav-drawer-link" style={{ color: 'var(--tx-3)', marginTop: '8px' }} onClick={onOpenLanding}>
            ← Back to landing
          </button>
        </div>
      )}
